...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'umkm_category', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['umkm.Category'], null=True))

    def backwards(self, orm):

        # Changing field 'Category.parent'
        db.alter_column(u'umkm_category', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['umkm.Category']))
    ...
    models = {
        ...
        u'umkm.category': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['umkm.Category']", 'null': 'True', 'blank': 'True'})
        },
        u'umkm.knowledge': {
