...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('umkm', ['Tag'])
        ...
        db.send_create_signal('umkm', ['Type'])
        ...
        db.send_create_signal('umkm', ['Category'])
        ...
        db.send_create_signal('umkm', ['Media'])
    ...
    models = {
        ...
        'umkm.category': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['umkm.Category']", 'null': 'True', 'blank': 'True'})
        },
        'umkm.media': {
            ...
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'media_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['umkm.Type']"}),
